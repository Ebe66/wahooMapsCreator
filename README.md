...
A tool to create up-to-date maps for your Wahoo ELEMNT BOLT and BOLTv2, ELEMNT ROAM and Wahoo ELEMNT! It runs on macOS, Unix as well as on Windows!

# Basic Overview
WahooMapsCreator is a tool to create maps based on the latest OSM maps for your Wahoo devices. You can generate maps the countries you like.
